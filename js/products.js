...
// Second-level filter, nested under a Category: pick a Category first, then
// its Subcategory options appear (both in the admin product form and on the
// storefront filter panel). Keyed as SUBCATEGORIES[topCategory][category].
export const SUBCATEGORIES = {
  women: {
    "Unstitched": ["Lawn","Cotton","Chiffon","Silk","Khaddar","Karandi","Linen"],
    "Stitched": ["1-Piece","2-Piece","3-Piece"],
    "Kurtis": ["Straight","A-Line","High-Low","Angrakha"],
    "Shalwar Kameez": ["2-Piece","3-Piece","With Dupatta"],
    "Lawn": ["Printed","Embroidered","Digital Print"],
    "Formals": ["Maxi","Gown","Saree","Sharara"],
    "Party Wear": ["Maxi","Gown","Saree","Sharara"],
    "Abayas": ["Open Abaya","Closed Abaya","Kimono"],
    "Hijabs": ["Chiffon","Jersey","Georgette","Pashmina"],
    "Accessories": ["Bags","Jewellery","Belts","Scarves"]
  },
  men: {
    "Shirts": ["Casual","Formal","Printed","Check"],
    "T-Shirts": ["Polo","Crew Neck","V-Neck","Graphic"],
    "Kurtas": ["Cotton","Linen","Silk","Embroidered"],
    "Shalwar Kameez": ["2-Piece","3-Piece"],
    "Waistcoats": ["Formal","Casual"],
    "Trousers": ["Chino","Formal","Denim","Cargo"],
    "Accessories": ["Belts","Wallets","Caps","Ties"]
  },
  kids: {
    "Girls": ["Frocks","Tops","Sets","Dresses"],
    "Boys": ["Shirts","T-Shirts","Sets","Shorts"],
    "Babies": ["Rompers","Sets","Sleepwear","Bibs"],
    "Accessories": ["Bags","Hats","Shoes","Socks"]
  }
};
