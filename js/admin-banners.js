...
import { esc, toast, optimizeImg } from "./utils.js";
...
function render() {
  document.getElementById("rows").innerHTML = banners.map((b) => `
    <tr>
      <td><img src="${esc(optimizeImg(b.image, 200))}" alt="" style="width:96px;height:48px;object-fit:cover;border-radius:8px"></td>
