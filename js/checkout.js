...
function paymentStep() {
  const methods = [
    { k: "cod", name: "BANK TRANSFER", desc: "Pay on our Easypaisa account# 03365062794 and Share receipt on Whatsapp 03365062794: As soon as we get the payment your order will be dispatched" }
  ];
  return `<div class="co-section">
    <h3>Payment</h3>
    <div class="pay-methods">
...
function showConfirmation() {
  ...
  document.getElementById("checkoutRoot").innerHTML = `
    <div class="confirm">
      ...
      <div class="ord-code-box">
        ...
        <span class="ord-code" id="ordCode">${esc(info.id || "——")}</span>
  ...
  if (copyBtn) copyBtn.onclick = async () => {
    try { await navigator.clipboard.writeText(info.id || ""); toast("Order number copied ✦", "ok"); }
