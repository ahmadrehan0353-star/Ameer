...
export async function adminDuplicateProduct(product) {
  const copy = { ...product, id: "p-" + Date.now(), name: product.name + " (copy)", featured: false, createdAt: new Date().toISOString() };
...
const SETTINGS_SEED = { storeName: "AMEER OFFICIAL", currency: "PKR", freeShipOver: 10000, taxRate: 8, email: "care@ameerofficial.example", phone: "" };
