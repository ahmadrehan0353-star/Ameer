...
import { usingFirebase, getStoreSettings, saveStoreSettings } from "./admin-data.js";
  ...
  body.innerHTML = `
    ...
    <div class="ad-panel">
      ...
      <div class="ad-form-grid">
        ...
        <div class="field"><label>Phone number</label><input id="s-phone" value="${esc(s.phone || "")}" placeholder="+92 300 0000000"></div>
  ...
  document.getElementById("saveBtn").onclick = async () => {
    ...
    try {
      await saveStoreSettings({
        ...
        freeShipOver: parseFloat(document.getElementById("s-ship").value) || 10000,
        taxRate: parseFloat(document.getElementById("s-tax").value) || 0
      });
      toast(live ? "Settings saved — now live on the storefront ✦" : "Settings saved (this browser only — connect Firebase to go live)", "ok");
